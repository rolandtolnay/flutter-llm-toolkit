---
description: Sync Flutter reference docs and optionally install Flutter-specific Claude Code skills from flutter-llm-toolkit
allowed-tools: [Bash, AskUserQuestion]
---

<objective>
Fetch the latest Flutter reference files from the flutter-llm-toolkit GitHub repo and the code quality gist, then write them to `docs/` in the current project. Optionally install Flutter-specific Claude Code skills to `.claude/skills/`.
...
REPO_API="https://api.github.com/repos/rolandtolnay/flutter-llm-toolkit/contents/references"
RAW_BASE="https://raw.githubusercontent.com/rolandtolnay/flutter-llm-toolkit/main/references"
...
```bash
curl -sf "https://api.github.com/repos/rolandtolnay/flutter-llm-toolkit/contents/skills" | jq -r '.[] | select(.type=="dir" and (.name | startswith("flutter-"))) | .name'
```
...
SKILLS_API="https://api.github.com/repos/rolandtolnay/flutter-llm-toolkit/contents/skills"
SKILLS_RAW="https://raw.githubusercontent.com/rolandtolnay/flutter-llm-toolkit/main/skills"
