...
Output: a `.md` file in the project's pattern docs directory (or user-specified location) that follows LLM documentation principles — terse rules, inline code, flat hierarchy, anti-patterns section, no prose filler.
